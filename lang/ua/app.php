...
return [
    ...
    'directions_title' => 'Освітньо-наукові програми докторів філософії. Дисертації та автореферати України. Академічні тексти України: дисертації, звіти, статті, монографії - uacademic.info',
    'directions_description' => 'Освітньо-наукові програми докторів філософії, дисертації за освітньо-науковими програмами, спеціальності ВАК, дисертації за спеціальностями, каталог дисертацій',
    'directions_keywords' => 'наукові програми, освітньо наукові програми, освітні галузі, спеціальності вак, каталог дисертацій, каталог авторефератів, дисертація, повний текст, автореферат, дисертації :year, академічні тексти, завантажити дисертацію, автореферат дисертації, uacademic',

    'directions_heading_1' => 'Перелік галузей знань і спеціальностей докторів філософії',
    'directions_heading_2' => 'Перелік наукових спеціальностей за ВАК',
